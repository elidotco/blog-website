...
const HeroCard = ({ icon, name, type, desc }) => {
  const imageData = [icon1, icon2, icon3];
  return (
    <div className="hero-card w-full lg:w-[31%] border-b flex flex-col gap-5 py-10 px-5 md:px-0 md:pr-5 md:border-r border-[#262626]">
      {/* Icon */}
      {/* Icons Logic to be added here */}
      <img src={imageData[icon]} alt="" className="w-8 h-8" />
      {/* Icon */}
